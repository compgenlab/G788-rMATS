...
From your rMATS output, pick a significant SE event and note the chromosome and coordinates (`chr`, `exonStart_0base`, `exonEnd`). Type the coordinates into the IGV search bar:

```
chr1:12,345,678-12,356,789
```
